...
public static void main(String [] args) {
	...
	driver.findElement(By.id("twotabsearchtextbox")).sendKeys("Apple iPhone 8 Plus");	
	...
	{
		if(phonearray.get(j).getText().contains("Apple iPhone 8 Plus")) {
			...
			map.put(int_phone_price, phone_href);
